...
internal sealed class SpecialistConfiguration : IEntityTypeConfiguration<Specialist>
{
    public void Configure(EntityTypeBuilder<Specialist> builder)
    {
        ...
        builder.HasIndex(specialist => specialist.UserId)
            .IsUnique();

        builder.Property(specialist => specialist.UserId)
            .IsRequired();

        builder.Property(specialist => specialist.SpecializationId)
            .IsRequired();

        builder.Property(specialist => specialist.PhoneNumber)
            .IsRequired();

        builder.Property(specialist => specialist.City)
            .IsRequired();
